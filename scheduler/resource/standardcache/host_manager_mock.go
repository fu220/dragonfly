...
//
//	mockgen -destination host_manager_mock.go -source host_manager.go -package standardcache
//
...
func (m *MockHostManager) LoadAll() []*Host {
	m.ctrl.T.Helper()
...
func (mr *MockHostManagerMockRecorder) LoadAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
