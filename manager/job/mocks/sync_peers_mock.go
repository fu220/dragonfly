...
func (m *MockSyncPeers) CreateSyncPeers(arg0 context.Context, arg1 []models.Scheduler, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSyncPeers", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateSyncPeers indicates an expected call of CreateSyncPeers.
func (mr *MockSyncPeersMockRecorder) CreateSyncPeers(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSyncPeers", reflect.TypeOf((*MockSyncPeers)(nil).CreateSyncPeers), arg0, arg1, arg2)
}
